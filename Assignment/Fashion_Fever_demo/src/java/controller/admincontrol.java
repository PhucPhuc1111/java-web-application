...
public class admincontrol extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        double revenue = a_dao.getrevenue();
        int no_user = u_dao.getnouser();
        int no_order = o_dao.getnoorder();
        List<Product> listp = dao.getAllProduct();
        List<User> listu = u_dao.getallUser();
        List<Order> listo = o_dao.getallOrder();
        request.setAttribute("revenue", revenue);
        request.setAttribute("no_user", no_user);
